...
provider "github" {
    token = "xxxxxxxx" # write your own github token
...
resource "github_repository" "myrepo" {
    name = "bookstore-repo"
    auto_init = true
    visibility = "private"  # or you can choose public (default)
}
...
resource "aws_instance" "tf-docker-ec2" {
    ...
    key_name = "firstkey" # your aws key.pem file name
    security_groups = ["ramicho-docker-sec-gr-203"] # !!!!!!!!!!!!
    tags = {
        Name = "ramicho-Web Server of Bookstore"
    }
    user_data = <<-EOF
          #! /bin/bash
          yum update -y
          ...
          TOKEN="xxxxxxxxxxxx"  # write your own github token
          FOLDER="https://$TOKEN@raw.githubusercontent.com/ramichoclarusway/bookstore-repo/main/"
...
resource "aws_security_group" "tf-docker-ec2-sec-gr" {
    name = "ramicho-docker-sec-gr-203"
    tags = {
